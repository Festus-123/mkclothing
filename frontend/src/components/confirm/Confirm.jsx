...
const Confirm = ({ onClick, close }) => {
  return (
    <div className='inset-0 fixed backdrop-blur-sm bg-black/40 z-50 flex items-center justify-center'>
        ...
        <div className='bg-white rounded-2xl p-2 flex flex-col items-center gap-3 w-[80%] md:w-[25%] pt-5'>
            <h1 className='font-bold text-xl md:text-2xl'>Are you sure ?</h1>
            <p className='text-sm p-2'>Click confirm to delete product be sure you want to proceed with this, once confirmed this action cannot be reversed! </p>
